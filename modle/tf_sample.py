...
def train_read_data_for_file(file, capacity,image_size):
    # 创建文件队列,不限读取的数量
...
def train_shuffle_batch(train_file_path,image_size, batch_size, capacity=1000, num_threads=3):
    images, lables = train_read_data_for_file(train_file_path, 1000,image_size)
...
if __name__=='__main__':
    ...
    saver_lables(img_path,train_filename,dict)
    train_read_data_for_file(train_filename,100,[80,280,1])
    a=train_shuffle_batch(train_filename,[80,280,1],100)
